...
from .configuration_randeng import RandengConfig


logger = logging.get_logger(__name__)

_CONFIG_FOR_DOC = "RandengConfig"
_TOKENIZER_FOR_DOC = "RandengTokenizer"
...
class PegasusEncoderLayer(nn.Module):
    def __init__(self, config: RandengConfig):
        super().__init__()
...
class PegasusEncoder(PegasusPreTrainedModel):
    ...
    Args:
        config: RandengConfig
        embed_tokens (nn.Embedding): output embedding
    """

    def __init__(self, config: RandengConfig, embed_tokens: Optional[nn.Embedding] = None):
...
class RandengModel(PegasusPreTrainedModel):
    def __init__(self, config: RandengConfig):
        super().__init__(config)
...
class RandengForConditionalGeneration(PegasusPreTrainedModel):
    base_model_prefix = "model"
    ...
    def __init__(self, config: RandengConfig):
        super().__init__(config)
        self.model = RandengModel(config)
...
class RandengForCausalLM(PegasusPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
